...
int main ()
{
	...
	for(l=0;l<=8;l++){
		...
		arc = fopen("est.txt","w");
		fputs("El numero de estudiantes es: ",arc);
		m=l+1;
		fprintf(arc,"%d \n",m);
		fprintf(arc,"%d \n",arr[l]);
	}
	...
	fprintf(arc,"Se registraron 10 estudiantes, de los cuales %d son mujeres y %d son hombres \n",mujer,hombre);
		fprintf(arc,"El promedio de las calificaciones de los estudiantes es: %f",k);
